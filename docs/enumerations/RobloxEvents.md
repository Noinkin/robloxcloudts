...
[robloxcloudts](../globals.md) / RobloxEvents

# Enumeration: RobloxEvents

Defined in: src/client/client.ts:141
...
| <a id="ready"></a> `Ready` | `"READY"` | Fired when the client is able to send API Requests | src/client/client.ts:143 |
| <a id="warn"></a> `Warn` | `"WARN"` | Fired when there is a minor error | src/client/client.ts:155 |
